...
This project demonstrates the fundamental mathematics and logic behind regression models without relying on high-level libbraries like `scikit-learn`. It includes both **Gradient Descent** and **Normal Equation** solvers,built-in evaluation metrics, and data visualization.
---
## ✨ Key Features
